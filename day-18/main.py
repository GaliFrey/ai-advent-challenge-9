"""Textual MCP browser and agent chat for day 18."""
...
class MCPAgentApp(App[None]):
    ...
    TITLE = "AI Advent · День 18 · SSH-журнал"
    ...
    def compose(self) -> ComposeResult:
        yield Static("ДЕНЬ 18 · SSH-ВХОДЫ И MCP", id="brand")
        ...
        with Horizontal(id="input-row"):
            yield Input(placeholder="Например: кто входил на VM за последний час?", id="question")
